...
public class VideoObjTest {
    ...
    public void testConstructorAndAttributes()
    {
        ...
        VideoObj video = new VideoObj("Interstellar", 2014, "Christopher Nolan");
        VideoObj video2=new VideoObj("newMovie",2023,"newDirector");
    ...
    public void testequals(){
        ...
        VideoObj video4=new VideoObj("newMovie",2023,"newDirector");
